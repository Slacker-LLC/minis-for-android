...
| targetSdk | 35 |
| minSdk | 26 |
| Android NDK | 28.0.12433566 or newer |
| CMake | 3.22.1 |
| Rust | stable + `aarch64-linux-android` target |

Gradle, minisd and rclone default to NDK `28.0.12433566`. Set
...
Set `ANDROID_NDK_HOME` to NDK `28.0.12433566` or newer, with the directory containing `toolchains/llvm/prebuilt`.
