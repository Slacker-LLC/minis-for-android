...
/**
 * Turns screen-node displacement into scroll-position displacement; content moves
 * opposite to the scroll position. In Minis the deltas come from accessibility
 * anchor samples, never from Root-side screenshots.
 */
object RootScrollMotionContract {
