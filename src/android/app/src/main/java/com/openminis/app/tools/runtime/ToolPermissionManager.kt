...
object ToolPermissionManager {
    ...
    private val table: Map<String, ToolPolicy> = mapOf(
        ...
        // [T-eta-media-search] Same gate as the photo listing it mirrors.
        "android.media.audio" to ToolPolicy(Level.MCP_ALLOWED, Level.MCP_CONFIRM),
        "search_audio" to ToolPolicy(Level.MCP_ALLOWED, Level.MCP_CONFIRM),
        "list_audio" to ToolPolicy(Level.MCP_ALLOWED, Level.MCP_CONFIRM),
        "search_recordings" to ToolPolicy(Level.MCP_ALLOWED, Level.MCP_CONFIRM),
        "android.media.files" to ToolPolicy(Level.MCP_ALLOWED, Level.MCP_CONFIRM),
        "search_files" to ToolPolicy(Level.MCP_ALLOWED, Level.MCP_CONFIRM),
