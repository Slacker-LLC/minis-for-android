...
object UbuntuPaths {
    ...
    /** Compatibility overload for callers that still pass filesDir; filesDir is deliberately ignored. */
    ...
    /** Compatibility overload for current recovery/file callers; filesDir is not a storage authority. */
    ...
    /** Session paths use `/data/adb/minis/sessions/<sessionId>`; globals use [resolveHostPath]. */
    ...
    /** Compatibility overload; cleanup always targets the fixed sessions root. */
