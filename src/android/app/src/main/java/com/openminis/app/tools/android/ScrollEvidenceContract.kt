...
enum class ScrollMovementSource {
    EVENT,
    ANCHOR_MOTION,
}

object ScrollEvidenceContract {
    /** Accessibility reports `-1` for "no delta in this event", which is not zero motion. */
