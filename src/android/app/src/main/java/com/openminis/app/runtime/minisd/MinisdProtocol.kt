...
object MinisdProtocol {
    ...
    /**
     * Persistent bind sources are owned by minisd. The legacy parameters stay
     * in the Kotlin call shape temporarily so later #43 recovery callers remain
     * source-compatible, but none of them is serialized on the wire.
     */
    ...
    fun ubuntuStart(
        ...
        shared: String = "",
        sessionsRoot: String = "",
    ): MinisdRequest = MinisdRequest(id = id, method = "ubuntu.start")
