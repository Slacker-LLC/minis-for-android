...
class LayerBackdrop internal constructor(
    ...
    // True only while layerBackdrop records its subtree. drawBackdrop consumers
    // of this same layer must not record themselves back into it (a documented
    // RenderThread SIGSEGV loop in the upstream Glass Bottom Sheet tutorial).
    internal var isRecordingContent: Boolean = false
