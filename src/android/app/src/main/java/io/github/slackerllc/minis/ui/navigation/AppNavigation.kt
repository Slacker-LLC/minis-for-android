package io.github.slackerllc.minis.ui.navigation
...
import io.github.slackerllc.minis.deeplink.DeepLinkAction
import io.github.slackerllc.minis.deeplink.DeepLinkCoordinator
import io.github.slackerllc.minis.ui.settings.KEY_LAUNCH_SESSION
import io.github.slackerllc.minis.ui.settings.getAppearancePrefs
...
import io.github.slackerllc.minis.ui.chat.ChatScreen
import io.github.slackerllc.minis.ui.sessions.SessionListScreen
import io.github.slackerllc.minis.ui.settings.AboutScreen
import io.github.slackerllc.minis.ui.settings.AddAgentLoopGroupsScreen
import io.github.slackerllc.minis.ui.settings.AddAgentLoopModelsScreen
import io.github.slackerllc.minis.ui.settings.AddCustomModelScreen
import io.github.slackerllc.minis.ui.settings.BackgroundSettingsScreen
import io.github.slackerllc.minis.ui.settings.AddModelsToGroupScreen
import io.github.slackerllc.minis.ui.settings.ShadowVoiceDetailScreen
import io.github.slackerllc.minis.ui.settings.AddProviderScreen
import io.github.slackerllc.minis.ui.settings.ModelEntryDetailScreen
import io.github.slackerllc.minis.ui.settings.ModelGroupDetailScreen
import io.github.slackerllc.minis.ui.settings.ModelGroupsScreen
import io.github.slackerllc.minis.ui.settings.ProviderDetailScreen
import io.github.slackerllc.minis.ui.settings.ProviderListScreen
import io.github.slackerllc.minis.ui.sandbox.FileBrowserScreen
import io.github.slackerllc.minis.ui.sandbox.FileBrowserViewModel
import io.github.slackerllc.minis.ui.sandbox.FileItem
import io.github.slackerllc.minis.ui.sandbox.FilePreviewScreen
import io.github.slackerllc.minis.ui.sandbox.RootfsManagementScreen
import io.github.slackerllc.minis.ui.settings.EnvironmentVariablesScreen
import io.github.slackerllc.minis.ui.settings.AppearanceScreen
import io.github.slackerllc.minis.ui.settings.SettingsScreen
import io.github.slackerllc.minis.ui.settings.SystemPermissionsScreen
import io.github.slackerllc.minis.ui.settings.SessionStorageDetailScreen
import io.github.slackerllc.minis.ui.settings.SkillDetailScreen
import io.github.slackerllc.minis.ui.settings.StorageManagementScreen
import io.github.slackerllc.minis.ui.settings.SkillFileViewerScreen
import io.github.slackerllc.minis.ui.settings.UsageStatsScreen
import io.github.slackerllc.minis.ui.settings.MinisSkillsBrowserScreen
import io.github.slackerllc.minis.ui.settings.MountDetailScreen
import io.github.slackerllc.minis.ui.settings.MountedFoldersScreen
import io.github.slackerllc.minis.ui.settings.SharedFolderDetailScreen
import io.github.slackerllc.minis.ui.settings.SharedFoldersScreen
import io.github.slackerllc.minis.ui.settings.SkillsManagementScreen
...
import io.github.slackerllc.minis.ui.settings.LogDetailScreen
import io.github.slackerllc.minis.ui.settings.LogManagementScreen
import io.github.slackerllc.minis.ui.settings.MemoryFileEditScreen
import io.github.slackerllc.minis.ui.settings.MemoryManagementScreen
import io.github.slackerllc.minis.ui.settings.OffloadPermissionScreen
import io.github.slackerllc.minis.ui.settings.ShizukuPermissionScreen
import io.github.slackerllc.minis.sandbox.RootfsManager
import io.github.slackerllc.minis.sandbox.TerminalSession
import io.github.slackerllc.minis.ui.terminal.TerminalScreen
import io.github.slackerllc.minis.ui.onboarding.OnboardingModelSelectionScreen
...
fun AppNavigation(
    ...
    val mountedFoldersStore = remember {
        (context.applicationContext as io.github.slackerllc.minis.MinisApp).mountedFoldersStore
    }
    ...
    LaunchedEffect(Unit) {
        ...
        val hasPendingShare =
            io.github.slackerllc.minis.share.ShareCoordinator.bufferVersion.value > 0
        ...
        val mode = if (
            io.github.slackerllc.minis.diagnostics.HangDetector.shouldForceHomeOnLaunch(context) ||
            io.github.slackerllc.minis.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(context) ||
            io.github.slackerllc.minis.diagnostics.LaunchCycleBeacon.shouldForceHomeOnLaunch()
        ) 3 else rawMode
    ...
    NavHost(
            ...
            SharedFolderDetailScreen(
                ...
                onBrowseFiles = {
                    ...
                    val label = when (folderId) {
                        "shared" -> ctx.getString(io.github.slackerllc.minis.R.string.shared_folder_name_shared)
                        "skills" -> ctx.getString(io.github.slackerllc.minis.R.string.shared_folder_name_skills)
                        "memory" -> ctx.getString(io.github.slackerllc.minis.R.string.shared_folder_name_memory)
                        else -> folderId
                    }
        ...
        composable(
            ...
            val category = io.github.slackerllc.minis.ui.sandbox.MirrorCatalog.categoryFromKey(categoryKey)
                ?: return@composable
            io.github.slackerllc.minis.ui.sandbox.MirrorCategoryDetailScreen(
                category = category,
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.MCP) {
            if (mcpRepository != null) {
                io.github.slackerllc.minis.ui.settings.MCPIntegrationsScreen(
                    mcpRepository = mcpRepository,
                    onBack = { navController.safePopBackStack() },
                    envVarRepository = envVarRepository,
                )
        ...
        composable(Routes.SOUL) {
            io.github.slackerllc.minis.ui.settings.SoulSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SCHEDULED_TASKS) {
            io.github.slackerllc.minis.ui.scheduled.ScheduledTasksScreen(
                onBack = { navController.safePopBackStack() },
                onEditTask = { taskId ->
        ...
        composable(
            ...
            io.github.slackerllc.minis.ui.scheduled.ScheduledTaskRunsScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
        ...
        composable(
            ...
            io.github.slackerllc.minis.ui.scheduled.ScheduledTaskEditScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
