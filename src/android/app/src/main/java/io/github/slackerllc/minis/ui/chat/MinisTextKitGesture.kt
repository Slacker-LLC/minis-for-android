    ...
    Popup(
        ...
        Surface(
            ...
            Row(
                ...
                val labelCopy = androidx.compose.ui.res.stringResource(io.github.slackerllc.minis.R.string.selection_copy)
                val labelAddToInput = androidx.compose.ui.res.stringResource(io.github.slackerllc.minis.R.string.selection_add_to_chat_input)
                val labelCopyMarkdown = androidx.compose.ui.res.stringResource(io.github.slackerllc.minis.R.string.selection_copy_markdown)
                val labelCopyRichText = androidx.compose.ui.res.stringResource(io.github.slackerllc.minis.R.string.selection_copy_rich_text)
                val labelReadAloud = androidx.compose.ui.res.stringResource(io.github.slackerllc.minis.R.string.selection_read_aloud)
                val toastCopiedAsMarkdown = androidx.compose.ui.res.stringResource(io.github.slackerllc.minis.R.string.selection_copied_as_markdown_toast)
                val toastCopiedAsRichText = androidx.compose.ui.res.stringResource(io.github.slackerllc.minis.R.string.selection_copied_as_rich_text_toast)
                ...
                val labelCopyTable = androidx.compose.ui.res.stringResource(
                    io.github.slackerllc.minis.R.string.markdown_table_copy_table)
                val labelCopyTableImage = androidx.compose.ui.res.stringResource(
                    io.github.slackerllc.minis.R.string.markdown_table_copy_table_image)
                    ...
                    add(SelectionAction(labelCopy) {
                        ...
                        if (text.isNotEmpty()) {
                            ...
                            toast(context.getString(
                                io.github.slackerllc.minis.R.string.selection_copied_toast, preview(text)))
                        }
                        controller.clearSelection()
                    })
