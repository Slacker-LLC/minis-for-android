...
import io.github.slackerllc.minis.scheduled.ScheduledRepeatMode
import io.github.slackerllc.minis.scheduled.ScheduledTargetMode
import io.github.slackerllc.minis.scheduled.ScheduledTask
import io.github.slackerllc.minis.scheduled.ScheduledTaskManager
...
class ScheduledTaskOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun handleRun(args: OffloadArgs): NativeOffloadResult {
        ...
        val sessionId = runBlocking {
            io.github.slackerllc.minis.scheduled.ScheduledAgentRunner.run(context, task)
        }
        val out = JSONObject()
            .put("id", id)
