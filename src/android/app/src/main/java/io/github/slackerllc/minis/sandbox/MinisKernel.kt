 ...
 * [io.github.slackerllc.minis.sandbox.ubuntu.UbuntuRuntime] / minisd.
 */
object MinisKernel {
    ...
    val bindMounts: MutableMap<String, String>
        get() = io.github.slackerllc.minis.sandbox.ubuntu.UbuntuPaths.bindMounts

    /**
     * Seed mount registry + SAF snapshot. Idempotent; called from
     * MinisApp.onCreate. Ubuntu runtime start is handled by
     * [io.github.slackerllc.minis.sandbox.ubuntu.UbuntuRuntime.ensureReady].
     */
    ...
    fun resolveHostPath(linuxPath: String): File? =
        io.github.slackerllc.minis.sandbox.ubuntu.UbuntuPaths.resolveHostPath(linuxPath)

    fun resolveSessionHostPath(sessionId: String, linuxPath: String, context: Context): File? =
        io.github.slackerllc.minis.sandbox.ubuntu.UbuntuPaths.resolveSessionHostPath(sessionId, linuxPath, context)
    ...
    fun registerGlobalBindMounts(context: Context) {
        val paths = io.github.slackerllc.minis.sandbox.ubuntu.UbuntuPaths
