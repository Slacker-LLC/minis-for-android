...
import io.github.slackerllc.minis.ui.components.PickerModalityFilter
import io.github.slackerllc.minis.ui.components.modelEntryPickerItems
...
fun AddModelsToGroupScreen(
    ...
    var quickTestEntry by remember { mutableStateOf<io.github.slackerllc.minis.data.model.ModelEntry?>(null) }
