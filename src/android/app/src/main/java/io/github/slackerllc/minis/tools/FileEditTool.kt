...
import io.github.slackerllc.minis.tools.internal.FileEditEngine
...
object FileEditTool {
    ...
    fun execute(argsJson: String, sessionId: String, context: Context): ToolExecutionResult {
        return try {
            ...
            val file = io.github.slackerllc.minis.sandbox.ubuntu.UbuntuPaths.resolveSessionHostPath(sessionId, path, context)
