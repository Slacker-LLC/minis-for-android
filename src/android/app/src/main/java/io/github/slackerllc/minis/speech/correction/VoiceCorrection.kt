package io.github.slackerllc.minis.speech.correction

import android.content.Context
import android.util.Log
import io.github.slackerllc.minis.MinisApp
import io.github.slackerllc.minis.shared.TextSegmenter
...
object VoiceCorrection {
    ...
    fun ensureInitialized(context: Context) {
        ...
        val dao = runCatching {
            io.github.slackerllc.minis.data.db.AppDatabase.getInstance(app).chatDao()
        }.getOrNull()
        if (dao != null) {
    ...
    fun buildConversationContext(
        context: Context,
        messages: List<io.github.slackerllc.minis.ui.chat.ChatMessage>,
    ): ConversationContext {
        ensureInitialized(context)
