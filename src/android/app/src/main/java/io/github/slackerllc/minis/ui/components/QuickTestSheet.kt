...
import io.github.slackerllc.minis.data.model.normalizeModalityName
...
internal suspend fun performTest(
    ...
    if (kind == QuickTestKind.SPEECH_OUT || kind == QuickTestKind.TRANSCRIPTION) {
        val voice = io.github.slackerllc.minis.provider.voice.VoiceProviderFactory.make(instance, apiKey)
                ...
                if (!voice.supportsVoiceOutput) {
                    ...
                    runCatching {
                        ...
                        val data = voice.synthesize(
                            io.github.slackerllc.minis.provider.voice.VoiceOutputRequest(
                ...
                if (!voice.supportsVoiceInput) {
                    ...
                    runCatching {
                        val resp = voice.transcribe(
                            io.github.slackerllc.minis.provider.voice.VoiceInputRequest(
                                audioData = clip,
