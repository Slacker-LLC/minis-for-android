...
internal object ChatMutationMethods {
     ...
     * [io.github.slackerllc.minis.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = io.github.slackerllc.minis.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                io.github.slackerllc.minis.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[io.github.slackerllc.minis.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", io.github.slackerllc.minis.service.SessionActivityTracker.isActive(sessionId))
