...
import io.github.slackerllc.minis.provider.voice.VoiceInputRequest
import io.github.slackerllc.minis.provider.voice.VoiceProvider
import io.github.slackerllc.minis.provider.voice.VoiceProviderException
...
class ProviderSpeechRecognitionEngine(private val appContext: Context) : SpeechRecognitionEngine {
    ...
    private fun startVadCapture(
        locale: Locale,
        repo: io.github.slackerllc.minis.data.repository.ProviderRepository,
        candidates: List<Pair<io.github.slackerllc.minis.data.model.ProviderInstance, io.github.slackerllc.minis.data.model.ModelEntry>>,
