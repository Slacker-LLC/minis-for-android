package io.github.slackerllc.minis.scheduled
...
import io.github.slackerllc.minis.service.AgentForegroundService
    ...
    private suspend fun resolveSessionId(app: MinisApp, task: ScheduledTask): String? {
        return when (val mode = task.targetMode) {
            ...
            ScheduledTargetMode.NewSession -> {
                ...
                val memoryOn = io.github.slackerllc.minis.data.MemoryGlobalPrefs.isGlobalEnabled(app)
