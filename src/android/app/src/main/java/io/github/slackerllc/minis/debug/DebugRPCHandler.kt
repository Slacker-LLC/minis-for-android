...
class DebugRPCHandler(private val context: Context) {
    ...
    private fun handleAppInfo(): JSONObject {
        ...
        return JSONObject().apply {
            ...
            val ubuntuRunning = io.github.slackerllc.minis.runtime.ubuntu.UbuntuRuntime.snapshot.value.running
    ...
    /**
     * T344: Direct invocation of [io.github.slackerllc.minis.runtime.guest.ShizukuOffloadHandler]
    ...
    private fun handleShizukuExec(params: JSONObject): JSONObject {
        ...
        val handler = io.github.slackerllc.minis.runtime.guest.ShizukuOffloadHandler(context)
        ...
        val request = io.github.slackerllc.minis.runtime.guest.NativeOffloadRequest(
            pid = -1,
    ...
    /**
     * Direct invocation of [io.github.slackerllc.minis.runtime.guest.ModelUseOffloadHandler]
    ...
    private fun handleModelUseExec(params: JSONObject): JSONObject {
        ...
        val finalArgv: List<String> = if (params.has("input")) {
            ...
            val hostFile = io.github.slackerllc.minis.runtime.RuntimePathRegistry.resolveHostPath(linuxPath)
        ...
        val handler = io.github.slackerllc.minis.runtime.guest.ModelUseOffloadHandler(context, app.providerRepository)
        val request = io.github.slackerllc.minis.runtime.guest.NativeOffloadRequest(
            pid = -1,
     ...
     * [io.github.slackerllc.minis.runtime.guest.SessionsOffloadHandler] for e2e
    ...
    private fun handleSessionsExec(params: JSONObject): JSONObject {
        ...
        val app = context.applicationContext as io.github.slackerllc.minis.MinisApp
        val handler = io.github.slackerllc.minis.runtime.guest.SessionsOffloadHandler(app.chatRepository)
        val request = io.github.slackerllc.minis.runtime.guest.NativeOffloadRequest(
            pid = -1,
