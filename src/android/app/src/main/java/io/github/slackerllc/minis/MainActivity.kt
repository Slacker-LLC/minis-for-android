...
import io.github.slackerllc.minis.accessibility.AccessibilityRecoveryManager
...
import io.github.slackerllc.minis.deeplink.DeepLinkHandler
import io.github.slackerllc.minis.logging.AppLogger
import io.github.slackerllc.minis.service.SessionActivityTracker
import io.github.slackerllc.minis.ui.navigation.AppNavigation
import io.github.slackerllc.minis.ui.navigation.Routes
import io.github.slackerllc.minis.ui.navigation.safeNavigate
import io.github.slackerllc.minis.ui.settings.KEY_FONT_APP_BASE
import io.github.slackerllc.minis.ui.settings.KEY_KEEP_SCREEN_AWAKE
import io.github.slackerllc.minis.ui.settings.KEY_LANGUAGE
import io.github.slackerllc.minis.ui.settings.KEY_LAUNCH_SESSION
import io.github.slackerllc.minis.ui.settings.KEY_THEME_MODE
import io.github.slackerllc.minis.ui.settings.KEY_UI_STYLE
import io.github.slackerllc.minis.ui.settings.PREF_APPEARANCE
import io.github.slackerllc.minis.ui.settings.getAppearancePrefs
import io.github.slackerllc.minis.ui.settings.fontScaleForLevel
import io.github.slackerllc.minis.ui.settings.keepScreenAwakeEnabled
import io.github.slackerllc.minis.ui.glass.GlassHost
import io.github.slackerllc.minis.ui.theme.MinisTheme
import io.github.slackerllc.minis.ui.theme.UiStyle
import io.github.slackerllc.minis.ui.theme.minisPageBackground
...
class MainActivity : ComponentActivity() {
     ...
     * [io.github.slackerllc.minis.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(io.github.slackerllc.minis.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onResume() {
        super.onResume()
        io.github.slackerllc.minis.pet.PetBridge.startIfEnabled(this)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (minisApp == null || !minisApp.subsystemsInitialized) {
            android.util.Log.w(
                ...
                "app subsystems not initialized (safeMode=" +
                    "${io.github.slackerllc.minis.crash.CrashFrequencyDetector.isSafeMode()}) — " +
                    "showing crash share dialog and finishing",
            )
            io.github.slackerllc.minis.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                io.github.slackerllc.minis.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        io.github.slackerllc.minis.share.ShareCoordinator.processPendingShare(this)
        ...
        io.github.slackerllc.minis.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        ...
        setContent {
            ...
            MinisTheme(
                ...
                io.github.slackerllc.minis.ui.settings.ConfigConfirmDialogHost()
                }
            }
        }
    }
     ...
     * is already covered by [io.github.slackerllc.minis.ui.navigation.AppNavigation]
    ...
    override fun onDestroy() {
        ...
        val handler = io.github.slackerllc.minis.debug.DebugRPCHandler.currentActivity
        if (handler?.get() === this) io.github.slackerllc.minis.debug.DebugRPCHandler.currentActivity = null
        super.onDestroy()
    }
