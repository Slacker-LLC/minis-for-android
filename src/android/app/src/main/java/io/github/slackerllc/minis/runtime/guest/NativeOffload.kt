...
object NativeOffloadServer {
    ...
    // OpenMinis Pet fork: abstract sockets share one kernel-global namespace,
    // so a fixed name collides with the official build whenever both are
    // installed — the loser cannot bind and dies in Application.onCreate().
