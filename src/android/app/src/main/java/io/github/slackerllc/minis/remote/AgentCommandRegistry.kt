...
import io.github.slackerllc.minis.debug.ChatMutationMethods
...
import io.github.slackerllc.minis.tools.SessionPermissionStore
...
object AgentCommandRegistry {
    ...
    private fun commandFeedbackText(context: Context, sessionId: String): String {
        val items = io.github.slackerllc.minis.tools.MessageFeedbackStore.listForSession(context, sessionId)
    ...
    private fun skillNames(context: Context, sessionId: String): List<String> = runCatching {
        val app = context.applicationContext as? io.github.slackerllc.minis.MinisApp ?: return emptyList()
