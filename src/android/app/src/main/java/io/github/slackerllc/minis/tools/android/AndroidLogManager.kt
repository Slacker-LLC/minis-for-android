package io.github.slackerllc.minis.tools.android
...
import io.github.slackerllc.minis.tools.internal.SpillPolicy
...
object AndroidLogManager {
    ...
    private object ShizukuManagerReady {
        fun value(): Boolean = runCatching { io.github.slackerllc.minis.offload.ShizukuManager.isReady() }.getOrDefault(false)
    }
}
