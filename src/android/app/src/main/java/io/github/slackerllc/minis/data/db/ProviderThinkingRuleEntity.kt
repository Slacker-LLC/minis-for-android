 ...
 * in [io.github.slackerllc.minis.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    ...
    /** Serialized [io.github.slackerllc.minis.provider.thinking.ThinkingWireFormat]; null = "no opinion". */
