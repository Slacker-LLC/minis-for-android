...
import io.github.slackerllc.minis.accessibility.MinisAccessibilityService
import io.github.slackerllc.minis.logging.AppLogger
import io.github.slackerllc.minis.offload.OffloadPermissionManager
import io.github.slackerllc.minis.offload.ShizukuManager
...
fun OffloadPermissionScreen(
    ...
    val configEnabled by io.github.slackerllc.minis.config.MinisConfigPermissionStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = {
                    io.github.slackerllc.minis.config.MinisConfigPermissionStore.setEnabled(it)
                },
                showDivider = false,
            )
        }
        ...
        AlertDialog(
            ...
            confirmButton = {
                MinisTextButton(onClick = {
                    ...
                    io.github.slackerllc.minis.config.MinisConfigPermissionStore.setEnabled(true)
