...
import io.github.slackerllc.minis.data.db.AppDatabase
import io.github.slackerllc.minis.data.repository.BackgroundSettingsRepository
...
import io.github.slackerllc.minis.data.MountedFoldersStore
...
import io.github.slackerllc.minis.data.repository.WebAppShortcutRepository
import io.github.slackerllc.minis.data.repository.MCPRepository
import io.github.slackerllc.minis.data.repository.SkillRepository
import io.github.slackerllc.minis.notification.BackgroundTaskNotifier
import io.github.slackerllc.minis.pet.PetBridge
import io.github.slackerllc.minis.logging.AppLogger
import io.github.slackerllc.minis.network.NetworkMonitor
import io.github.slackerllc.minis.offload.OffloadPermissionManager
import io.github.slackerllc.minis.provider.ModelsDevApi
import io.github.slackerllc.minis.sandbox.ExecutionCoordinator
import io.github.slackerllc.minis.sandbox.MountedFolderCoordinator
import io.github.slackerllc.minis.sandbox.NativeOffloadServer
import io.github.slackerllc.minis.sandbox.MinisKernel
import io.github.slackerllc.minis.sandbox.RootfsManager
import io.github.slackerllc.minis.sandbox.ubuntu.UbuntuRuntime
import io.github.slackerllc.minis.sandbox.offload.AccessibilityOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.AlarmOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.BrowserUseOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.CalendarOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.ClipboardOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.ContactsOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.DeviceOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.LocationOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.ModelUseOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.SessionsOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.ShizukuOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.NotificationOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.OpenOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.PhotosOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.PlayerOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.SpeakOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.SpeechOffloadHandler
import io.github.slackerllc.minis.sandbox.offload.WeatherOffloadHandler
import io.github.slackerllc.minis.service.SessionActivityTracker
import io.github.slackerllc.minis.ui.MinisImageFetcher
...
class MinisApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        io.github.slackerllc.minis.data.FastModePrefs.prime(this)
        ...
        // Activity context.
        io.github.slackerllc.minis.data.AutoCompactPrefs.prime(this)
        ...
        // libs first execute.
        try {
            io.github.slackerllc.minis.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, io.github.slackerllc.minis.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        io.github.slackerllc.minis.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        if (io.github.slackerllc.minis.crash.CrashFrequencyDetector.isSafeMode()) {
        ...
        // [io.github.slackerllc.minis.diagnostics.LaunchCycleBeacon].
        try {
            io.github.slackerllc.minis.diagnostics.LaunchCycleBeacon.recordLaunch(this)
        } catch (t: Throwable) {
        ...
        io.github.slackerllc.minis.diagnostics.HangDetector.start(this)
        ...
        chatRepository = ChatRepository(database.chatDao()) { sessionId ->
            io.github.slackerllc.minis.sandbox.ubuntu.UbuntuPaths.deleteSession(
                applicationContext,
                sessionId,
            )
        }
        ...
        io.github.slackerllc.minis.ui.chat.SessionEventHub.installDurableStore(database.chatDao())
        ...
        io.github.slackerllc.minis.mcp.client.MCPProvider.init(mcpRepository, this)
        io.github.slackerllc.minis.mcp.client.MCPProvider.reload()
        ...
        io.github.slackerllc.minis.agent.SoulStore.ensureExists(this)
        io.github.slackerllc.minis.agent.SoulStore.refreshCache(this)
        ...
        io.github.slackerllc.minis.config.MinisConfigPermissionStore.init(this)
        io.github.slackerllc.minis.config.audit.ConfigAuditLog.init(this)
        io.github.slackerllc.minis.config.ConfigRegistry.init(
        ...
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.RootShellHandler(),
            aliasNames = listOf("shell_root"),
        )
        // P10: linux.file.* ops (host-side workspace, bind-visible to guest)
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileAppendHandler(), listOf("append_file"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileCopyHandler(), listOf("copy_file"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileMoveHandler(), listOf("move_file"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileDeleteHandler(), listOf("delete_file"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileListHandler(), listOf("list_files"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileSearchHandler(), listOf("search_files"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileGrepHandler(), listOf("file_grep"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileHeadTailHandler(), listOf("file_head_tail"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.LinuxFileInfoHandler(), listOf("file_info"))
        // P10: android.* system tools (standard APIs, no root)
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidWebSearchHandler(), listOf("web_search"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidUrlFetchHandler(), listOf("url_fetch"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidCalendarReadHandler(), listOf("read_calendar"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidCalendarCreateHandler(), listOf("create_calendar_event"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidCalendarUpdateHandler(), listOf("update_calendar_event"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidCalendarDeleteHandler(), listOf("delete_calendar_event"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidContactsSearchHandler(), listOf("search_contacts"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidContactsManageHandler(), listOf("manage_contacts"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidLocationHandler(), listOf("get_location"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidClipboardHandler(), listOf("clipboard"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidTimeHandler(), listOf("get_current_time"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidSendIntentHandler(), listOf("send_intent"))
        // P10 Gate 3b: standard API Wi-Fi/Bluetooth read-only queries.
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidWifiInfoHandler(), listOf("wifi_info"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidWifiScanHandler(), listOf("list_wifi_networks"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidBluetoothStatusHandler(), listOf("bluetooth_status"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidBluetoothPairedHandler(), listOf("bluetooth_paired_devices"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidBluetoothScanHandler(), listOf("bluetooth_scan"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidTtsVoicesHandler(), listOf("list_tts_voices"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidTtsVoiceHandler(), listOf("set_tts_voice"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidTtsEnabledHandler(), listOf("set_tts_enabled"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidMediaImagesHandler(), listOf("list_media_images"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidAppUsageHandler(), listOf("app_usage"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidMediaInfoHandler(), listOf("get_media_info"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidMediaControlHandler(), listOf("control_media"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidWeatherHandler(), listOf("get_weather"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidDialHandler(), listOf("dial_phone"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidSettingsGetHandler(), listOf("system.get_setting"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidSettingsSetHandler(), listOf("system.set_setting"))
        // P10 Gate 3b: telephony read-only (SMS/Call Log).
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidSmsReadHandler(), listOf("read_sms"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(io.github.slackerllc.minis.tools.AndroidCallLogReadHandler(), listOf("read_call_log"))
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.LinuxFileReadHandler(),
            aliasNames = listOf("file_read"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.LinuxFileWriteHandler(),
            aliasNames = listOf("file_write"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.LinuxFileEditHandler(),
            aliasNames = listOf("file_edit"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.LinuxShellHandler(),
            aliasNames = listOf("shell_execute"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.LinuxPythonRunHandler(),
        )
        // android.* remainder (logs/diagnose/deploy) via generic handler
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AndroidToolHandler(
                io.github.slackerllc.minis.tools.android.AndroidAgentTools.LOGS,
                "android.logs",
            ),
        ...
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AndroidToolHandler(
                io.github.slackerllc.minis.tools.android.AndroidAgentTools.DIAGNOSE,
                "android.diagnose",
            ),
        ...
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AndroidToolHandler(
                io.github.slackerllc.minis.tools.android.AndroidAgentTools.DEPLOY,
                "android.deploy",
            ),
        ...
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AndroidToolHandler(
                io.github.slackerllc.minis.tools.android.AndroidAgentTools.CAPABILITIES,
        ...
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AndroidToolHandler(
                io.github.slackerllc.minis.tools.android.AndroidAgentTools.APP,
                "android.app",
            ),
        ...
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AndroidToolHandler(
                io.github.slackerllc.minis.tools.android.AndroidAgentTools.UI,
                "android.ui",
            ),
        ...
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.LinuxReadImageHandler(),
            aliasNames = listOf("read_image"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AgentGoalHandler(),
            aliasNames = listOf("get_goal", "create_goal", "update_goal"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AgentTodoHandler(),
            aliasNames = listOf("todo_write"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AgentSubagentHandler(),
            aliasNames = listOf("subagent"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AgentAskHandler(),
            aliasNames = listOf("ask_user_question"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.SystemJobsHandler(),
            aliasNames = listOf("job_list", "job_kill", "job_output"),
        )
        io.github.slackerllc.minis.tools.runtime.ToolRegistry.register(
            io.github.slackerllc.minis.tools.runtime.AgentRalphHandler(),
        ...
        io.github.slackerllc.minis.tools.runtime.ProviderRouter.reset()
        io.github.slackerllc.minis.tools.runtime.ProviderRouter.register(
            io.github.slackerllc.minis.tools.runtime.LinuxProvider(
                available = { UbuntuRuntime.snapshot.value.available },
                revive = { UbuntuRuntime.ensureReady().running },
            ),
        )
        io.github.slackerllc.minis.tools.runtime.ProviderRouter.register(
            io.github.slackerllc.minis.tools.runtime.PrefixProvider("android", listOf("android.")),
        )
        io.github.slackerllc.minis.tools.runtime.ProviderRouter.register(
            io.github.slackerllc.minis.tools.runtime.PrefixProvider("root", listOf("root.")),
        )
        io.github.slackerllc.minis.tools.runtime.ProviderRouter.register(
            io.github.slackerllc.minis.tools.runtime.PrefixProvider("core", listOf("system.", "agent.")),
        )
        io.github.slackerllc.minis.tools.runtime.ProviderRouter.register(
            io.github.slackerllc.minis.tools.runtime.PrefixProvider("mcp", listOf("mcp.")),
        )
        io.github.slackerllc.minis.tools.runtime.ProviderRouter.register(
            io.github.slackerllc.minis.tools.runtime.PrefixProvider("skill", listOf("skill.")),
        )

        // Privacy Mode store + redactor wiring. Mirrors iOS
        // EnvVarPrivacyStore.init / EnvVarRedactor static handoff.
        io.github.slackerllc.minis.data.EnvVarPrivacyStore.init(this)
        io.github.slackerllc.minis.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        NativeOffloadServer.register(
            "minis-config",
            io.github.slackerllc.minis.sandbox.offload.ConfigOffloadHandler(),
        )
        ...
        NativeOffloadServer.register(
            "minis-scheduled",
            io.github.slackerllc.minis.sandbox.offload.ScheduledTaskOffloadHandler(this),
        )
        ...
        io.github.slackerllc.minis.offload.ShizukuManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            NativeOffloadServer.register(
                "minis-debug",
                io.github.slackerllc.minis.sandbox.offload.DebugOffloadHandler(this),
            )
        }
        ...
        io.github.slackerllc.minis.mcp.server.MCPServerManager.init(this)
        ...
        io.github.slackerllc.minis.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            io.github.slackerllc.minis.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        val configConfirmNotifier = io.github.slackerllc.minis.notification.ConfigConfirmNotifier(
            context = this,
            backgroundSettings = backgroundSettingsRepository,
            isAppForeground = ::isAppForeground,
        )
        io.github.slackerllc.minis.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        io.github.slackerllc.minis.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                io.github.slackerllc.minis.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    io.github.slackerllc.minis.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
        ...
        io.github.slackerllc.minis.speech.SpeechRecognitionManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            try {
                io.github.slackerllc.minis.debug.DebugServer(this).start()
            } catch (e: Exception) {
    ...
    override fun onTrimMemory(level: Int) {
        ...
        runCatching { io.github.slackerllc.minis.ui.chat.KatexWebViewPool.evictAll() }
            .onFailure { Log.w("MinisApp", "KatexWebViewPool.evictAll failed: ${it.message}") }
        runCatching { io.github.slackerllc.minis.ui.markdown.KaTeXRendererCache.evictAll() }
        ...
        if (level >= TRIM_MEMORY_COMPLETE) {
            ...
            runCatching { io.github.slackerllc.minis.ui.chat.KatexWebViewPool.releaseWebView() }
    ...
    override fun onTerminate() {
        ...
        try {
            io.github.slackerllc.minis.diagnostics.LaunchCycleBeacon.recordCleanExit(this)
        } catch (t: Throwable) {
