package io.github.slackerllc.minis.auth
...
abstract class OAuthManager(
    ...
    companion object {
        ...
        internal val httpClient = io.github.slackerllc.minis.provider.ProviderTransportPolicy
        ...
        fun forInstance(context: Context, instance: io.github.slackerllc.minis.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                io.github.slackerllc.minis.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                io.github.slackerllc.minis.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                io.github.slackerllc.minis.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                io.github.slackerllc.minis.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    suspend fun startLogin(onComplete: (Boolean) -> Unit) {
        ...
        val url = io.github.slackerllc.minis.provider.ProviderTransportPolicy
    ...
    private fun getEncryptedPrefs() =
        io.github.slackerllc.minis.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
