...
class LinuxFileReadHandler : ToolHandler {
    override val definition: AgentToolDefinition =
        io.github.slackerllc.minis.tools.FileReadTool.definition().copy(name = "linux.file.read")
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.FileReadTool.execute(argsJson, sessionId, context)
}

class LinuxFileWriteHandler : ToolHandler {
    override val definition: AgentToolDefinition =
        io.github.slackerllc.minis.tools.FileWriteTool.definition().copy(name = "linux.file.write")
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.FileWriteTool.execute(argsJson, sessionId, context)
}

class LinuxFileEditHandler : ToolHandler {
    override val definition: AgentToolDefinition =
        io.github.slackerllc.minis.tools.FileEditTool.definition().copy(name = "linux.file.edit")
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.FileEditTool.execute(argsJson, sessionId, context)
}

class LinuxShellHandler : ToolHandler {
    override val definition: AgentToolDefinition =
        io.github.slackerllc.minis.tools.AgentTools.shellExecuteDefinition(name = "linux.shell")
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult {
        ...
        val result = io.github.slackerllc.minis.runtime.ExecutionCoordinator.execute(
            sessionId = sessionId,
            command = command,
            timeout = timeoutMs,
        )
...
class LinuxPythonRunHandler : ToolHandler {
    override val definition: AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            "tool_title" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "A concise 5-10 word summary shown to the user."),
            "code" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Python 3 code to execute."),
            "timeout" to io.github.slackerllc.minis.data.model.AgentToolParam("integer", "Timeout in seconds (default 300, max 900)."),
        ),
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult {
        ...
        try {
            val write = io.github.slackerllc.minis.tools.FileWriteTool.execute(
            ...
            val host = io.github.slackerllc.minis.runtime.ubuntu.UbuntuPaths.resolveSessionHostPath(
                sessionId,
                scriptPath,
                context,
            )
...
private fun io.github.slackerllc.minis.runtime.ExecutionCoordinator.FailureKind?.toToolFailureKind(): ToolFailureKind? = when (this) {
    io.github.slackerllc.minis.runtime.ExecutionCoordinator.FailureKind.TOOL_TIMEOUT -> ToolFailureKind.TOOL_TIMEOUT
    io.github.slackerllc.minis.runtime.ExecutionCoordinator.FailureKind.TRANSPORT_TIMEOUT -> ToolFailureKind.TRANSPORT_TIMEOUT
    io.github.slackerllc.minis.runtime.ExecutionCoordinator.FailureKind.PROCESS_KILLED -> ToolFailureKind.PROCESS_KILLED
    io.github.slackerllc.minis.runtime.ExecutionCoordinator.FailureKind.CLEANUP_FAILURE -> ToolFailureKind.CLEANUP_FAILURE
    io.github.slackerllc.minis.runtime.ExecutionCoordinator.FailureKind.RUNTIME_FAILURE, null -> null
}
...
class AndroidToolHandler(
    ...
    override val definition: AgentToolDefinition
        get() {
            val legacy = io.github.slackerllc.minis.tools.android.AndroidAgentTools.definitions()
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.android.AndroidAgentTools.execute(
            name = legacyName,
            argsJson = argsJson,
            sessionId = sessionId,
            context = context,
...
class LinuxReadImageHandler : ToolHandler {
    override val definition: AgentToolDefinition =
        io.github.slackerllc.minis.tools.ReadImageTool.definition().copy(name = "linux.file.image.read")
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.ReadImageTool.execute(argsJson, sessionId, context)
}
...
class AgentGoalHandler : ToolHandler {
    override val definition: AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            "tool_title" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Short summary of this call, shown to the user."),
            "action" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "get_goal | create_goal | update_goal."),
            "goal" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "The goal text for create_goal/update_goal."),
        ),
        required = listOf("tool_title", "action"),
        propertyOrdering = listOf("tool_title", "action", "goal"),
    )
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.GoalTools.execute(JSONObject(argsJson).optString("action"), argsJson, sessionId, context)
}
...
class AgentTodoHandler : ToolHandler {
    override val definition: AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            "tool_title" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Short summary of this call, shown to the user."),
            "todos" to io.github.slackerllc.minis.data.model.AgentToolParam(
                "array", "Full replacement list of todos.",
                items = io.github.slackerllc.minis.data.model.AgentToolParam(
                    "object", "One todo.",
                    properties = mapOf(
                        "title" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Todo text."),
                        "status" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "pending|in_progress|completed|skipped (default pending)."),
                        "id" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Optional stable id."),
                    ),
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.TodoTool.execute(argsJson, sessionId, context)
}
...
class AgentSubagentHandler : ToolHandler {
    override val definition: AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            "tool_title" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Short summary of the delegated task, shown to the user."),
            "prompt" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "The complete, self-contained task for the child agent."),
        ),
        required = listOf("tool_title", "prompt"),
        propertyOrdering = listOf("tool_title", "prompt"),
    )
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.SubagentTool.execute(argsJson, sessionId, context)
}
...
class AgentAskHandler : ToolHandler {
    override val definition: AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            "tool_title" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Short summary of the question, shown to the user."),
            "question" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "The question to ask the user, in the user's language."),
            "options" to io.github.slackerllc.minis.data.model.AgentToolParam(
                "array", "Optional answer choices, each {label, value, recommended?}.",
                items = io.github.slackerllc.minis.data.model.AgentToolParam(
                    "object", "One answer choice.",
                    properties = mapOf(
                        "label" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Human-readable label."),
                        "value" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Stable machine-readable value."),
                        "recommended" to io.github.slackerllc.minis.data.model.AgentToolParam("boolean", "Optional hint shown to the user."),
                    ),
                    requiredProperties = listOf("label", "value"),
                ),
            ),
            "multiple" to io.github.slackerllc.minis.data.model.AgentToolParam("boolean", "Allow multiple selections (default false)."),
            "allowCustom" to io.github.slackerllc.minis.data.model.AgentToolParam("boolean", "Allow a free-form custom answer (default true)."),
            "timeoutMinutes" to io.github.slackerllc.minis.data.model.AgentToolParam("integer", "How long to wait for the user (1-30, default 10)."),
        ),
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.AskUserQuestionTool.execute(argsJson, sessionId, context)
}
...
class SystemJobsHandler : ToolHandler {
    override val definition: AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            "tool_title" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Short summary of this call, shown to the user."),
            "action" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "job_list | job_kill | job_output."),
            "job_id" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "The id of the background job (job_kill/job_output)."),
            "wait" to io.github.slackerllc.minis.data.model.AgentToolParam("boolean", "Block until the job reaches a terminal status (job_output, default false)."),
            "timeout_ms" to io.github.slackerllc.minis.data.model.AgentToolParam("integer", "Maximum wait in milliseconds when wait=true (default 30000)."),
            "reason" to io.github.slackerllc.minis.data.model.AgentToolParam("string", "Optional short reason for job_kill."),
        ),
        required = listOf("tool_title", "action"),
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.JobTools.execute(JSONObject(argsJson).optString("action"), argsJson, sessionId, context)
}

class AgentRalphHandler : ToolHandler {
    override val definition: AgentToolDefinition =
        io.github.slackerllc.minis.tools.RalphTool.definition().copy(name = "agent.ralph")
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult =
        io.github.slackerllc.minis.tools.RalphTool.execute(argsJson, sessionId, context)
}
