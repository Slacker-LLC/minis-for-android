...
class LinuxShellHandler : ToolHandler {
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult {
        ...
        val result = io.github.slackerllc.minis.sandbox.ExecutionCoordinator.execute(
            sessionId = sessionId,
            command = command,
...
class AgentGoalHandler : ToolHandler {
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult {
        ...
        return io.github.slackerllc.minis.tools.GoalTools.execute(name, argsJson, sessionId, context)
    }
}
...
class SystemJobsHandler : ToolHandler {
    ...
    override suspend fun execute(argsJson: String, sessionId: String, context: Context, toolId: String): ToolExecutionResult {
        val name = org.json.JSONObject(argsJson).optString("action")
        return io.github.slackerllc.minis.tools.JobTools.execute(name, argsJson, sessionId, context)
    }
}
