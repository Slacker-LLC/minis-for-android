...
fun EnvironmentVariablesScreen(
    ...
    val privacyEnabled by io.github.slackerllc.minis.data.EnvVarPrivacyStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = { io.github.slackerllc.minis.data.EnvVarPrivacyStore.setEnabled(it) },
                showDivider = false,
            )
        }
