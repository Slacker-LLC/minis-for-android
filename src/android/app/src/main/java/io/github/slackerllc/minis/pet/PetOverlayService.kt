...
import io.github.slackerllc.minis.speech.RecognitionError
...
import io.github.slackerllc.minis.speech.SystemSpeechRecognitionEngine
...
class PetOverlayService : Service() {
    ...
    private val readAloudPlayer by lazy { io.github.slackerllc.minis.speech.ReadAloudPlayer(this) }
    ...
    private fun voiceErrorText(
        error: io.github.slackerllc.minis.speech.RecognitionError,
        message: String?,
    ): String = when (error) {
