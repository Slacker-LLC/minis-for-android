...
/**
 * One configurable setting. Concrete kinds: [io.github.slackerllc.minis.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [io.github.slackerllc.minis.config.fields.ClosureField]
