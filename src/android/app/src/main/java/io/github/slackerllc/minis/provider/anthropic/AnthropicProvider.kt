package io.github.slackerllc.minis.provider.anthropic
...
import io.github.slackerllc.minis.data.model.sanitizeToolId
...
class AnthropicProvider(
    ...
    internal fun resolveSystemPrompt(userPrompt: String?): JSONArray? {
        if (isOAuth) {
            ...
            val claudeCodePrefix = oauthIdentifierPromptOverride
                ?: io.github.slackerllc.minis.auth.ClaudeOAuthManager.ANTHROPIC_OAUTH_IDENTIFIER_PROMPT
    ...
    private fun buildRequest(bodyStr: String, body: JSONObject): Request {
        ...
        builder.applyUserAgentOverride(
            customUserAgent,
            defaultUserAgent = if (isOAuth) null else io.github.slackerllc.minis.provider.MinisUserAgent.DEFAULT,
        )
