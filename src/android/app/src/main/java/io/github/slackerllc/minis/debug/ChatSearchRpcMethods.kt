 ...
 * ([io.github.slackerllc.minis.data.repository.ChatRepository.searchMessages]):
...
internal object ChatSearchRpcMethods {
    ...
    suspend fun search(context: Context, params: JSONObject): JSONObject = withContext(Dispatchers.IO) {
        ...
        val grouped = LinkedHashMap<String, MutableList<io.github.slackerllc.minis.data.repository.MessageSearchMatch>>()
        for (m in matches) {
