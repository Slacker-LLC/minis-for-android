...
class AgentForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_STOP = "io.github.slackerllc.minis.STOP_AGENT_SERVICE"
    ...
    override fun onCreate() {
        ...
        if (!((applicationContext as? io.github.slackerllc.minis.MinisApp)?.subsystemsReady() == true)) {
    ...
    private fun buildNotification(sessionCount: Int, toolStatus: String): Notification {
        ...
        val mainIntent = Intent(this, Class.forName("io.github.slackerllc.minis.MainActivity")).apply {
