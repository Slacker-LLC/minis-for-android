package io.github.slackerllc.minis.webapp

import android.content.Context
import io.github.slackerllc.minis.data.db.WebAppShortcutEntity
...
object WebAppPathResolver {
    ...
    fun inferScope(hostFile: File): Triple<String, String?, String>? {
        ...
        val sorted = io.github.slackerllc.minis.sandbox.MinisKernel
