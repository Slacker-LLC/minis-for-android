...
Java_io_github_slackerllc_minis_sandbox_PtyBridge_forkExec(
...
JNIEXPORT jint JNICALL
Java_io_github_slackerllc_minis_sandbox_PtyBridge_readBytes(
...
JNIEXPORT jint JNICALL
Java_io_github_slackerllc_minis_sandbox_PtyBridge_writeBytes(
    JNIEnv *env, jclass clazz, jint fd, jbyteArray buf, jint off, jint len)
{
    if (fd < 0 || len <= 0) return -EINVAL;
    jbyte *data = (*env)->GetByteArrayElements(env, buf, NULL);
...
JNIEXPORT jint JNICALL
Java_io_github_slackerllc_minis_sandbox_PtyBridge_setWindowSize(
...
JNIEXPORT jint JNICALL
Java_io_github_slackerllc_minis_sandbox_PtyBridge_closeFd(
...
JNIEXPORT jint JNICALL
Java_io_github_slackerllc_minis_sandbox_PtyBridge_sendSignal(
...
JNIEXPORT jint JNICALL
Java_io_github_slackerllc_minis_sandbox_PtyBridge_waitFor(
